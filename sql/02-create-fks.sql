...
ALTER TABLE cnae_secundaria ADD CONSTRAINT fk_cnae_secundaria_cnpj FOREIGN KEY (cnpj) REFERENCES empresa (cnpj);
...
ALTER TABLE cnae_secundaria ADD CONSTRAINT fk_cnae_secundaria_cnae FOREIGN KEY (cnae) REFERENCES cnae (id);
